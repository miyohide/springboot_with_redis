...
export class Network extends Construct {
    ...
    constructor(scope: Construct, id: string) {
        ...
        this.appRunnerSecurityGroup = new SecurityGroup(scope, 'AppRunnerSecurityGroup', {
            vpc: this.vpc,
        ...
        this.appRunnerSecurityGroup.addEgressRule(this.cacheSecurityGroup, Port.tcp(6379));

        // CacheセキュリティグループにてAppRunnerセキュリティグループからポート6379の通信を許可
        this.cacheSecurityGroup.addIngressRule(this.appRunnerSecurityGroup, Port.tcp(6379));
    }
}
